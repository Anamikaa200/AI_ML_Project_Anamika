...
st.set_page_config(page_title="Male vs Female Eye Classification", layout="wide")
st.title("👤 Male vs Female Eye Classification")
...
st.markdown("- LinkedIn: www.linkedin.com/in/anamika-yadav-64b688340")
